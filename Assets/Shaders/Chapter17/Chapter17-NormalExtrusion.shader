Shader "Unity Shaders Book/Chapter 17/Normal Extrusion"
{
	...
	SubShader
	{
		...
		// exclude_path:deferred/exclude_path:prepass - do not generate passes for deferred/legacy deferred rendering path.
		// nometa - do not generate a “meta” pass
		//          (that’s used by lightmapping & dynamic global illumination to extract surface information).
